...
export default function RoleCard({
  ...
  const content = (
    <div className="deep-glass relative flex h-full min-h-[280px] flex-col p-6 sm:min-h-[340px] sm:p-7 md:min-h-[360px] md:p-8 cursor-pointer">
  ...
  if (onClick) {
    return (
      <div onClick={onClick} className="group block h-full focus-visible:outline-none">
        {content}
      </div>
    );
  }
